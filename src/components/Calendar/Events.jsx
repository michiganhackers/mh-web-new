...
const Events = () => (
    <React.Fragment>
        ...
        <SubpageOuter header="calendar">
            ...
            <a style={{ float: "right" }} href="https://calendar.google.com/calendar/selfsched?sstoken=UVA3dk1tZkxNOFpCfGRlZmF1bHR8ODMwMzEwNjE4YzY3Y2I0OThlZGIzY2IwMGU1MDUwMGI">Office hours signup</a>
        </SubpageOuter>
    </React.Fragment>
);
