...
const Events = () => (
    <React.Fragment>
        ...
        <SubpageOuter header="calendar">
            ...
            <a style={{ float: "right" }} href="https://calendar.google.com/calendar/u/0/selfsched?sstoken=UUZvRjlEM0RMUlZ2fGRlZmF1bHR8NjkzODc3M2I3MDJlZGM5NDQyZDU2M2IzMzc4YTM2NjY">Office hours signup</a>
        </SubpageOuter>
    </React.Fragment>
);
