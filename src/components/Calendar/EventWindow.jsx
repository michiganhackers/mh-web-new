        ...
        if (!this.props.hidden) {
            return (
                ...
                >
                    <TitleContainer>
                        <ToolbarContainer>
                            <CalendarButton onClick={this.props.closeWindow}>
                                &#10005;
                            </CalendarButton>
                            <CalendarButton onClick={this.openLink}>
                    ...
                    <BodyContainer>
                        <CalendarField
                            ...
                            text={this.formatDateTime(
                                this.props.eventClicked.start,
                                this.props.eventClicked.end,
                                this.props.eventClicked.hasTime
                            )}
                        />
                        <CalendarField
                            icon="map-marker-alt"
                            text={this.props.eventClicked.location}
                        />
                        <CalendarField
                            icon="list-ul"
                            text={this.props.eventClicked.description}
                        />
                    </BodyContainer>
                </Wrapper>
            );
