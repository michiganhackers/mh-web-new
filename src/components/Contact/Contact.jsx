    ...
    <SubTheme name="contact">
      ...
      <Outer>
        <SubTheme name="details">
          ...
          <ForStudentsDiv>
            <InfoP>
              For students interested in participating with Michigan Hackers,
              join our Slack workspace and subscribe to our mailing list to stay
              in touch with upcoming hack nights, corporate events, and socials.
          ...
          <ForCompaniesDiv>
            <InfoP>
              ...
              beneficial partnerships with companies. In the past, we have had
              events such as engineering panels, technical workshops, recruiting
              coffee chats, coding competitions with companies. For companies
              interested in sponsoring and collaborating with Michigan Hackers,
              please reach out at -{" "}
              <a href="mailto:michiganhackers-exec@umich.edu">
                michiganhackers&#8209;exec@umich.edu
              </a>
