...
const FAQ = () => (
    <>
        ...
        <SubpageOuter header="frequently asked questions (faq)">
            <Question question="You guys hack?"
            ...
            <Question question="Can I join Michigan Hackers? How? What’s the process?"
            ...
            <Question question="Can I join a team if I’m not an official member?"
            ...
            <Question question="I’m new to computer science and programming! Can I still be involved?"
            ...
            <Question question="What are Michigan Hackers' teams?"
            ...
            <Question question="I'm interested in multiple teams. Can I be on more than one?"
            ...
            <Question question="How do I become an official member?"
            ...
            <Question question="What are Hack Nights? What do you do?"
            ...
            <Question question="I have class during Hack Nights! How can I still be involved?"
            ...
            <Question question="What are Office Hours for?"
            ...
            <Question question="What are membership benefits? Responsibilities?"
            ...
            <Question question="I have an exam! Can I excuse my absence?"
            ...
            <Question question="What makes you guys different?"
                //newlines can be added by making it a js string and adding the \n escape character
                answer={"We're dynamic. We're not afraid of shifting our focus if we need to and are constantly aiming to evolve to fit the needs of Michigan students interested in technology and computer science. That means we have plenty of social, professional, and technical resources for everyone to take advantage of!" +
