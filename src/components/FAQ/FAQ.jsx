			...
			<React.Fragment>
				...
				<SubpageOuter header="frequently asked questions (faq)">
					<Question
						...
						answer="Yes...we hack things...together ;) What we mean by “hacking” is mashing the old and the new together, which helps us learn more about the world and programming."
					/>
					<Question
						question="Can I join Michigan Hackers and how? What’s the process?"
						answer="Yes! Any student can come to our events and be a guest. While you are welcome to be involved as a guest, open clubs naturally have a problem with adding value without a membership process (i.e. you can arbitrarily join a bunch and declare yourself a member). Therefore, we also have an official process with other tiers to demonstrate passion and unlock extra benefits. Our membership structure is as follows:
Guest, Core Member, Core Lead, Executive Board"
					/>
					<Question
						question="Can I join a Core team if I’m not an official Core member?"
						answer="Yes, you can! Core teams and members are separate. We recommend not officially joining a project until you qualify for Core membership, since we want you to get a feel for our organization and stay committed."
					/>
					<Question
						question="I’m new to computer science and programming! Can I still be involved?"
						answer="No. Just kidding! We love students who are open and passionate about learning about code. We just ask that you are committed to putting in some time and effort to engage with our resources to help you gain technical skills, whether it be through our teams and members/leads with immense knowledge or the guides and talks they share.
On another note, we always need people on the Creative core team, which has amazing opportunities to get a handle on our large social media audience (larger than most on campus), graphic design, and photography. It’s awesome because you can make things that you physically see being worn, shared, and used around campus and the internet!"
					/>
					<Question
						question="How do I become an official Core Member?"
